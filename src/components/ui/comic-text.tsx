...
export function ComicText({
  ...
  const activeFontSize = fontSize || sizes[scale]
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        fontFamily: "var(--font-bangers), 'Bangers', 'Comic Sans MS', 'Impact', sans-serif",
        fontWeight: "900",
        WebkitTextStroke: `${activeFontSize * 0.35}px #000000`, // Thick black outline
