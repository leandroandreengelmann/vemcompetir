            ...
            <div className="max-w-2xl mx-auto px-6 py-8 flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="space-y-1">
                        <h1 className="text-3xl font-bold tracking-tight text-primary">Cadastrar academia</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 mt-2">
                    <div className="space-y-6">
                        <div className="space-y-2">
                            <Label htmlFor="gym_name" className="text-sm font-medium text-muted-foreground">Nome da academia / equipe</Label>
                            <Input
                                id="gym_name"
                                name="gym_name"
