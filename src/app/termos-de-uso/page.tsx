...
export const metadata = {
    title: 'Termos de Uso — Competir',
    description: 'Conheça os Termos de Uso da plataforma Competir.',
};
                ...
                {data ? (
                    <div className="prose-sm">
                        ...
                        <div className="mt-12 pt-6 border-t text-xs text-muted-foreground">
                            Versão {data.version} — Atualizado em {new Date(data.created_at).toLocaleDateString('pt-BR', { day: '2-digit', month: 'long', year: 'numeric' })}
                        </div>
                    </div>
                ) : (
                    <p className="text-muted-foreground text-center py-16">
                        Termos de uso não disponíveis no momento.
                    </p>
                )}
            </div>
        </div>
