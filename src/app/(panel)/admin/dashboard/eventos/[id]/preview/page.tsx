        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="bg-amber-500 text-amber-950 px-4 py-2 flex items-center justify-between z-[60] sticky top-0 border-b border-amber-600/20 shadow-sm">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs uppercase tracking-wider">Modo de Prévia (Administrador)</span>
                </div>
                <Badge variant="outline" className="bg-amber-600/10 border-amber-600/20 text-amber-900 text-xs uppercase px-2 py-0 h-5">
                    Status: {event.status}
                </Badge>
            </div>
