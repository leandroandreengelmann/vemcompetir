            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {loading
                    ...
                    : eventos.map((ev) => (
                          <div
                              key={ev.id}
                              className="rounded-2xl border border-border/50 p-6 space-y-4 hover:border-primary/30 hover:shadow-sm transition-all flex flex-col"
                          >
                              <div className="space-y-2 flex-1">
                                  <h3 className="font-bold text-lg line-clamp-2">{ev.name}</h3>
                                  <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-panel-sm text-muted-foreground">
                                      {ev.event_date && (
