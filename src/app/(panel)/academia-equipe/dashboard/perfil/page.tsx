...
export default async function AcademiaPerfilPage() {
    ...
    if (!profile) {
        return (
            <div className="p-6">
                <h1 className="text-h2 text-destructive mb-2">Erro</h1>
                <p className="text-body text-card-foreground">Perfil não encontrado no sistema.</p>
            </div>
        );
    }
    ...
    return (
        <div className="flex-1 space-y-6 p-4 md:p-8 pt-6">
            <div className="flex items-center justify-between space-y-2">
                <div>
                    <h2 className="text-h2 font-bold tracking-tight">Meu Perfil</h2>
