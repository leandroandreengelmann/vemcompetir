...
import { WalletIcon, CheckCircleIcon, WarningCircleIcon, MoneyIcon, ShoppingBagIcon } from '@phosphor-icons/react';
        ...
        <div className="space-y-8">
                    ...
                    <CardContent className="p-8 flex items-center justify-between">
                        <div className="space-y-2">
                            <div className="flex items-center gap-2 text-emerald-500 dark:text-emerald-400">
                                ...
                                <span className="text-panel-sm font-semibold">Confirmado / Recebido</span>
                            </div>
                            ...
                            <p className="text-panel-sm font-medium text-emerald-500/80">{data?.summary.paid_count || 0} inscrições pagas</p>
                        </div>
                        <MoneyIcon size={64} weight="duotone" className="text-emerald-500/20 -rotate-12 group-hover:scale-110 transition-transform duration-500" />
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="p-8 flex items-center justify-between">
                        <div className="space-y-2">
                            <div className="flex items-center gap-2 text-amber-500 dark:text-amber-400">
                                ...
                                <span className="text-panel-sm font-semibold">Aguardando Pagamento</span>
                            </div>
                            ...
                            <p className="text-panel-sm font-medium text-amber-500/80">{data?.summary.pending_count || 0} inscrições pendentes</p>
                        </div>
                        <WalletIcon size={64} weight="duotone" className="text-amber-500/20 rotate-12 group-hover:scale-110 transition-transform duration-500" />
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="p-8 flex items-center justify-between">
                        <div className="space-y-2">
                            <div className="flex items-center gap-2 text-sky-500 dark:text-sky-400">
                                ...
                                <span className="text-panel-sm font-semibold">Na Cesta de Compras</span>
                            </div>
                            ...
                            <p className="text-panel-sm font-medium text-sky-500/80">{data?.summary.cart_count || 0} inscrições na cesta de compras</p>
                        </div>
                        <ShoppingBagIcon size={64} weight="duotone" className="text-sky-500/20 rotate-12 group-hover:scale-110 transition-transform duration-500" />
                    </CardContent>
                </Card>
            </div>
            ...
            <Card className="border-none shadow-sm bg-background/50 backdrop-blur-sm">
                <CardContent className="p-6">
                    <h3 className="text-panel-md font-semibold mb-6">Fluxo de Inscrições</h3>
                    <div className="rounded-2xl border border-border/50 overflow-hidden">
                        <Table>
                            <TableHeader className="bg-muted/30">
                                <TableRow className="hover:bg-transparent border-border/50">
                                    <TableHead className="text-panel-sm font-semibold h-11">Data Criação</TableHead>
                                    ...
                                    <TableHead className="text-panel-sm font-semibold h-11 text-right">Valor Bruto</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {loading ? (
                                        ...
                                        <TableRow key={idx} className="hover:bg-muted/20 transition-colors border-border/50">
                                            ...
                                            <TableCell>
                                                <Badge variant="outline" className={cn(
                                                    "text-panel-sm font-semibold px-2 font-semibold uppercase tracking-wider",
