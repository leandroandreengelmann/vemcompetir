                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-4">
                            ...
                            <div>
                                ...
                                <div>
                                    <span className={`inline-block text-panel-sm font-bold uppercase tracking-wider px-2 py-0.5 mt-1 border rounded-md shadow-sm ${getBeltBadgeStyle(athlete.belt_color)}`}>
