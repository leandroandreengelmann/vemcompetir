...
export default function EditEventForm({ event }: EditEventFormProps) {
    ...
    const [imagePreview, setImagePreview] = useState<string | null>(
        event.image_path ? `${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/event-images/${event.image_path}` : null
    );
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setError(err.message || 'Ocorreu um erro ao atualizar o evento.');
            setLoading(false);
        }
    };
    ...
    return (
        <div className="flex flex-col items-center justify-center py-6 sm:py-12 px-4 relative">
            <div className="w-full max-w-2xl space-y-10">
                <div className="space-y-6">
                    ...
                    <SectionHeader
                        title="Editar Evento"
                        description="Atualize os dados e o endereço do evento selecionado."
