...
### 🔴 MANDATORY DESIGN SYSTEM ADHERENCE
Before any UI/UX or styling task, you MUST read `.agent/DESIGN_SYSTEM.md` to ensure project-specific typography tokens, color palettes, and component rules are followed.
